...
%%%%%%%%%%%%%%%%%%%%
% IMPORTANT
% THIS DOCUMENT REQUIRES LuaLaTeX AS THE PROCESSING ENGINE
...
\usepackage[svgnames]{xcolor} % Adds more colors to the available list. It has to be loaded before any pgf package
